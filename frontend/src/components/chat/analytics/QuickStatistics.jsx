...
function QuickStatistics({ colStart, rowStart, statistic, statisticValue }) {
    return (
        <div className="col-span-1 row-span-1rounded-4xl bg-gray-100 rounded-3xl p-2 flex flex-col justify-center" style={{ gridColumnStart: colStart, gridRowStart: rowStart }}> 
