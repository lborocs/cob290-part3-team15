        ...
        <Modal open={open} onClose={onClose} refs={refs.setFloating} floatingStyles={floatingStyles} bgColor="bg-backgroundOrange" accentColor="bg-orangeHover">
            <div className="py-6 px-8 bg-accentOrange rounded-lg shadow-lg w-full max-w-md mx-auto">
                ...
                <div className="flex justify-end space-x-4">
                    <button className="mt-4 py-2 px-2 bg-orangeHover shadow-sm text-black font-bold rounded-lg w-full select-none" onClick={onClose}>Cancel</button>
                    <button className="mt-4 py-2 px-2 bg-orangeHover shadow-sm text-black font-bold rounded-lg w-full select-none" onClick={handleRename}>Confirm</button>
                </div>
            </div>
        </Modal>
    );
